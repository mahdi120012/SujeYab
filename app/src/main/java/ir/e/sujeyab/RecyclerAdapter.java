...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerAdapter.MyViewHolder holder, final int position) {
        ...
        if (rowLayoutType.matches("farakhan_vije")){
            ...
            String ax = rModels.get(position).getAx();
            if (ax.isEmpty()) {
            ...
            holder.txOnvan2.setText(rModels.get(position).getAx());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        TextView txOnvan,txModatBaghiMande,txMatnKholase,txTedadComment,txTedadLike,txOnvan2;
